...
//     {
//         bool currentAlarmRinging = isAlarmRinging();

//         if (currentAlarmRinging && !lastAlarmRinging)
//         {
...
//         lastAlarmRinging = currentAlarmRinging;

//         // Check for alarm card scan
//         if (currentAlarmRinging)
//         {
...
//         updateAlarmDisplay();
//         Serial.println(newState ? "Alarm enabled" : "Alarm disabled");
//     }
// }
